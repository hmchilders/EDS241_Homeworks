...
# Intercept 23.33 is the average employment at fast food restaurants in PA, pretreatment
# delta (treated coefficient) = -2.89 mean difference in employment at ff restaurants in both NJ and PA, pre treatment)
# alpha (post_treat coefficient)= -2.16 mean change in employment at ff restaurants in PA between pretreatment time and post treatment time)
# b3 (interaction)= 2.75 This is our coefficient of interest. The effect of the updated minimum wage law on employment. 
